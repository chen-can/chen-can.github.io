import{_ as s,c as n,o as a,f as l}from"./app.a423845e.js";const i=JSON.parse('{"title":"公用样式","description":"","frontmatter":{},"headers":[],"relativePath":"FrontEnd/CSS/CSS_Style.md","lastUpdated":1665897289000}'),p={name:"FrontEnd/CSS/CSS_Style.md"},o=l(`<h1 id="公用样式" tabindex="-1">公用样式 <a class="header-anchor" href="#公用样式" aria-hidden="true">#</a></h1><div class="language-css"><button title="Copy Code" class="copy"></button><span class="lang">css</span><pre class="shiki material-palenight"><code><span class="line"><span style="color:#676E95;font-style:italic;">/* 颜色变量 */</span></span>
